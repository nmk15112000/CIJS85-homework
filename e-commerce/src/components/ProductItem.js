...
const ProductItem = ({ index = 1, onClick,onClickRemove, name, price, discount }) => {
  return (
    <div className="py-2 px-4 border border-gray-400 rounded-md inline-flex flex-col gap-2">
      ...
      <button className="py-2 bg-red-400 rounded-md" onClickRemove={onClickRemove}>
        <p className="text-white">Remove from cart</p>
      </button>
    </div>
  );
};
